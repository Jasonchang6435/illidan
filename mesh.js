class GuaMesh extends GuaObject {
    ...
    static cube() {
        ...
        let vertices = []
        let colors = [GuaColor.red(),GuaColor.blue(),GuaColor.green(),GuaColor.white(),GuaColor.new(234,210,244,255)]
    ...
    static fromGua3d(gua3dString) {
        ...
        for (var i = 0; i < vectors.length; i++) {
            ...
            let v = GuaVector.new(vector[0], vector[1], vector[2])
            let vu = vector[6]
            let vv = vector[7]
            ...
            vertices.push(GuaVertex.new(v, c, vu, vv))
        }
